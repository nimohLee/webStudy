...
// console.log(Boolean(0)); // Boolean은 0을 제외한 모든 값 true.

let names = ["kim", "lee", "park", "choi", "jeong"];
...
if (passwd.length > 12 && passwd.includes("@")) console.log("비밀번호 좋다..");
else if (passwd.length >= 8) console.log("비밀번호 적당하다");
else console.log("비밀번호 너무 짧다. 다시..");
